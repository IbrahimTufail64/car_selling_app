...
const DamagedAbsentFixtures = () => {
    ...
    useEffect(()=>{
        ...
        retrieve('damaged_absent_fixtures1',setSampleImage1);
        retrieve('damaged_absent_fixtures2',setSampleImage2);
        retrieve('damaged_absent_fixtures3',setSampleImage3);
        retrieve('damaged_absent_fixtures4',setSampleImage4);
  ...
  return (
    <div className={`${isVendor ? 'bg-primaryDark text-white' : 'bg-secondary'} w-full `}>
        ...
        <div className='space-y-3 pt-7'>
            <PhotoFrame Content='Title here' isUploaded={SampleImage1 !== undefined} photo={ SampleImage1 ? SampleImage1 : ExampleImage}  link ='damaged_absent_fixtures1'/>
            <PhotoFrame Content='Title here' isUploaded={SampleImage2 !== undefined} photo={SampleImage2 ? SampleImage2 : ExampleImage} link ='damaged_absent_fixtures2'/>
            <PhotoFrame Content='Title here' isUploaded={SampleImage3 !== undefined} photo={SampleImage3 ? SampleImage3 :  ExampleImage} link ='damaged_absent_fixtures3'/>
            <PhotoFrame Content='Title here' isUploaded={SampleImage4 !== undefined} photo={SampleImage4 ? SampleImage4 : ExampleImage} link ='damaged_absent_fixtures4'/>
        </div>
...
export default DamagedAbsentFixtures
