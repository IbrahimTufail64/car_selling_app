  ...
  return (
    <div className={`${isVendor ? 'bg-primaryDark text-white' : 'bg-secondary'} w-full min-h-[100vh] pb-[90px]`}>
        ...
        <div className='space-y-3 pt-7'>
            {images.length === 0 && <PhotoFrameDynamic image_name='dashboard_lights' Car_no={car_no} DynamicImageNo={1} Content='Dashboard and lights' isUploaded={false} photo={ ExampleImage}  return_link ='dashboard_lights'/>}
