...
const SurfaceMarks = () => {
  ...
  return (
    <div className={`${isVendor ? 'bg-primaryDark text-white' : 'bg-secondary'} w-full `}>
        ...
        <Link  href='./panel_damage'><IoChevronBack size={28} className='mt-[3px]'/></Link>
        ...
        <div className='p-5'>
                <Link href='./panel_damage' className={`flex justify-center font-bold text-lg rounded-[6px] space-x-2 px-5 py-4 bg-tertiary ${isVendor && 'text-primaryDark'}`}>
