...
const SurfaceMarks = () => {
    ...
    useEffect(()=>{
        ...
        retrieve('panel_damage1',setSampleImage1);
        retrieve('panel_damage2',setSampleImage2);
        retrieve('panel_damage3',setSampleImage3);
        retrieve('panel_damage4',setSampleImage4);
  ...
  return (
    <div className={`${isVendor ? 'bg-primaryDark text-white' : 'bg-secondary'} w-full `}>
        ...
        <div className='space-y-3 pt-7'>
            <PhotoFrame Content='Title here' isUploaded={SampleImage1 !== undefined} photo={ SampleImage1 ? SampleImage1 : ExampleImage}  link ='panel_damage1'/>
            <PhotoFrame Content='Title here' isUploaded={SampleImage2 !== undefined} photo={SampleImage2 ? SampleImage2 : ExampleImage} link ='panel_damage2'/>
            <PhotoFrame Content='Title here' isUploaded={SampleImage3 !== undefined} photo={SampleImage3 ? SampleImage3 :  ExampleImage} link ='panel_damage3'/>
            <PhotoFrame Content='Title here' isUploaded={SampleImage4 !== undefined} photo={SampleImage4 ? SampleImage4 : ExampleImage} link ='panel_damage4'/>
        </div>
