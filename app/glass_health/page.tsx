...
const GlassHealth = () => {
    ...
    useEffect(()=>{
        ...
        retrieve('glass_health1',setSampleImage1);
        retrieve('glass_health2',setSampleImage2);
        retrieve('glass_health3',setSampleImage3);
        retrieve('glass_health4',setSampleImage4);
  ...
  return (
    <div className={`${isVendor ? 'bg-primaryDark text-white' : 'bg-secondary'} w-full `}>
        ...
        <div className='space-y-3 pt-7'>
            <PhotoFrame Content='Title here' isUploaded={SampleImage1 !== undefined} photo={ SampleImage1 ? SampleImage1 : ExampleImage}  link ='glass_health1'/>
            <PhotoFrame Content='Title here' isUploaded={SampleImage2 !== undefined} photo={SampleImage2 ? SampleImage2 : ExampleImage} link ='glass_health2'/>
            <PhotoFrame Content='Title here' isUploaded={SampleImage3 !== undefined} photo={SampleImage3 ? SampleImage3 :  ExampleImage} link ='glass_health3'/>
            <PhotoFrame Content='Title here' isUploaded={SampleImage4 !== undefined} photo={SampleImage4 ? SampleImage4 : ExampleImage} link ='glass_health4'/>
        </div>
